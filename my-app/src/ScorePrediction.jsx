...
import axios from "axios";
      ...
      const ScorePrediction = () => {
        ...
        const [runPerBall, setRunPerBall] = useState('');
        ...
        const handleSubmit = async (e) => {
          ...
          const formData = {
            ...
            over: over,
            ball: ball,
            batsman: selectedBatter,
            non_striker: selectedNonStriker,
            bowler: selectedBowler,
            run_per_ball: runPerBall,
            score: score,
            crr: crr,
          ...
          try {
            // Send form data to Express server using axios
            const response = await axios.post("http://localhost:4000/run", formData);
          ...
          <div id="abc">
            <main className="item">
                ...
                <div id="first">
                  ...
                  <div className="f">
                    ...
                    <input
                      ...
                      type="number"
                      value={runPerBall}
                      onChange={(e) => setRunPerBall(e.target.value)}
                      min="0"
                      max="7"
                      required
                    />
              ...
              <div id="divi">
                ...
                <p id="par"> Predicted Score:<strong>{Math.floor(pred)}</strong></p>
              </div>
              )}
              </form>
